...
var convert = function (json) {
  ...
  for (var id in parsedData.advisories) {
    ...
    report.vulnerabilities.push({
      ...
      "cve": "package.json:" + advisory.module_name + ":cve_id:" + (advisory.cves[0] ? advisory.cves[0] : "hello"),
      "description": advisory.overview,
      "severity": (capitalize(advisory.severity)) === "Moderate" ? "Medium" : capitalize(advisory.severity),
      ...
      "identifiers": [
        {
          "type": "cve_id",
          "name": advisory.cves[0] ? advisory.cves[0] : "hello",
          "value": advisory.cves[0] ? advisory.cves[0] : "hello",
